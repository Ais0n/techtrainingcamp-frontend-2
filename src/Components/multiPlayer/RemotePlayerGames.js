  ...
  render() {
    return (
      <div className="RemotePlayerGames" style={remotePlayerGamesStyle}>
        <div style={{gridRow: "1", gridColumn: "1"}}><RemotePlayerGame boardSize={this.props.boardSize} board={this.props.board} name={this.props.name} score={this.props.score} isGameStarted={this.props.isGameStarted}></RemotePlayerGame></div>
